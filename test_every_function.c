...
/*   Updated: 2024/04/03 11:19:08 by shebaz           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int ft_counter(char const *str, char c)//done
{
    int i;
    int word_counter;
...
int check_duplicate(int *arr, int argc, char **argv)//done
{
    int i;
    int j;
...
int *check_arguments(int argc, char **argv)//done
{
    int i;
    int j;
	int k;
