...
/*   Updated: 2024/05/07 21:17:22 by shebaz           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void				push_min_to_stacka(int ele, t_stack **stackA,
						t_stack **stackB);
...
int					calculate_min_element(t_stack *stackA, t_stack *stackB,
						int long nbr);
int					calcule_mouvement_stackb(t_stack *stackB, t_stack *stackA,
						int ele);
int					cal_mouvement_stacka(t_stack *stackA, int ele, int k,
						int *move);
t_stack				*copied_stack(t_stack *stack_to_copy);

int					min_element(t_stack *stackA);
void				execute_print_move(t_stack **stackA, t_stack **stackB,
						char *str);
